...
This means that the previous model code can be changed as the following.  
...
We can use the following code to complie the model and train the model by **gradient descent**.  
...
This means that the previous code can be changed as the following.  
