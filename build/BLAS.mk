...
$(BIN_DIR)/BLAS-Linear-Regression-Normal-Equation: $(OBJ_DIR)/BLAS-Linear-Regression-normal-equation-main.o $(BIN_DIR)/libopenblasp.so $(BIN_DIR)/libgfortran.so $(BIN_DIR)/libquadmath.so
	...
	$(HIDE) clang++ -pie $(LD_FLAGS) $(OBJ_DIR)/BLAS-Linear-Regression-normal-equation-main.o $(BIN_DIR)/libopenblasp.so $(BIN_DIR)/libgfortran.so $(BIN_DIR)/libquadmath.so -o $(BIN_DIR)/BLAS-Linear-Regression-Normal-Equation
...
$(BIN_DIR)/BLAS-Linear-Regression-Gradient-Descent: $(OBJ_DIR)/BLAS-Linear-Regression-gradient-descent-main.o $(BIN_DIR)/libopenblasp.so $(BIN_DIR)/libgfortran.so $(BIN_DIR)/libquadmath.so
	$(HIDE) mkdir -p $(BIN_DIR)
	$(HIDE) clang++ -pie $(LD_FLAGS) $(OBJ_DIR)/BLAS-Linear-Regression-gradient-descent-main.o $(BIN_DIR)/libopenblasp.so $(BIN_DIR)/libgfortran.so $(BIN_DIR)/libquadmath.so -o $(BIN_DIR)/BLAS-Linear-Regression-Gradient-Descent
...
$(BIN_DIR)/BLAS-Logistic-Regression: $(OBJ_DIR)/BLAS-Logistic-Regression-main.o $(BIN_DIR)/libopenblasp.so $(BIN_DIR)/libgfortran.so $(BIN_DIR)/libquadmath.so
	$(HIDE) mkdir -p $(BIN_DIR)
	$(HIDE) clang++ -pie $(LD_FLAGS) $(OBJ_DIR)/BLAS-Logistic-Regression-main.o $(BIN_DIR)/libopenblasp.so $(BIN_DIR)/libgfortran.so $(BIN_DIR)/libquadmath.so -o $(BIN_DIR)/BLAS-Logistic-Regression

# Compile
$(OBJ_DIR)/BLAS-Linear-Regression-normal-equation-main.o: $(CODE_DIR)/BLAS/Linear-Regression/normal-equation-main.cpp
	$(HIDE) mkdir -p $(OBJ_DIR)
	$(HIDE) clang++ -c $(CXX_FLAGS) $(CODE_DIR)/BLAS/Linear-Regression/normal-equation-main.cpp -MD -MF $(OBJ_DIR)/BLAS-Linear-Regression-Normal-Equation-main.d -o $(OBJ_DIR)/BLAS-Linear-Regression-normal-equation-main.o

$(OBJ_DIR)/BLAS-Linear-Regression-gradient-descent-main.o: $(CODE_DIR)/BLAS/Linear-Regression/gradient-descent-main.cpp
	$(HIDE) mkdir -p $(OBJ_DIR)
	$(HIDE) clang++ -c $(CXX_FLAGS) $(CODE_DIR)/BLAS/Linear-Regression/gradient-descent-main.cpp -MD -MF $(OBJ_DIR)/BLAS-Linear-Regression-Gradient-Descent-main.d -o $(OBJ_DIR)/BLAS-Linear-Regression-gradient-descent-main.o

$(OBJ_DIR)/BLAS-Logistic-Regression-main.o: $(CODE_DIR)/BLAS/Logistic-Regression/main.cpp
	$(HIDE) mkdir -p $(OBJ_DIR)
	$(HIDE) clang++ -c $(CXX_FLAGS) $(CODE_DIR)/BLAS/Logistic-Regression/main.cpp -MD -MF $(OBJ_DIR)/BLAS-Logistic-Regression-main.d -o $(OBJ_DIR)/BLAS-Logistic-Regression-main.o
