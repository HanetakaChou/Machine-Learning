...
all : \
	$(BIN_DIR)/Deep-Learning-Logistic-Regression \
	$(BIN_DIR)/Deep-Learning-Multinomial-Logistic-Regression

# Link
$(BIN_DIR)/Deep-Learning-Logistic-Regression: $(OBJ_DIR)/Deep-Learning-Logistic-Regression-inference-main.o $(BIN_DIR)/libOpenCL.so $(BIN_DIR)/libtensorflowlite_c.so
	$(HIDE) mkdir -p $(BIN_DIR)
	$(HIDE) clang++ -pie $(LD_FLAGS) $(OBJ_DIR)/Deep-Learning-Logistic-Regression-inference-main.o $(BIN_DIR)/libOpenCL.so $(BIN_DIR)/libtensorflowlite_c.so -o $(BIN_DIR)/Deep-Learning-Logistic-Regression

$(BIN_DIR)/Deep-Learning-Multinomial-Logistic-Regression: $(OBJ_DIR)/Deep-Learning-Multinomial-Logistic-Regression-inference-main.o $(BIN_DIR)/libOpenCL.so $(BIN_DIR)/libtensorflowlite_c.so $(BIN_DIR)/libopenblasp.so.0 $(BIN_DIR)/libgfortran.so.5 $(BIN_DIR)/libquadmath.so.0
	$(HIDE) mkdir -p $(BIN_DIR)
	$(HIDE) clang++ -pie $(LD_FLAGS) $(OBJ_DIR)/Deep-Learning-Multinomial-Logistic-Regression-inference-main.o $(BIN_DIR)/libOpenCL.so $(BIN_DIR)/libtensorflowlite_c.so $(BIN_DIR)/libopenblasp.so.0 $(BIN_DIR)/libgfortran.so.5 $(BIN_DIR)/libquadmath.so.0 -o $(BIN_DIR)/Deep-Learning-Multinomial-Logistic-Regression
...
$(BIN_DIR)/libOpenCL.so: $(OBJ_DIR)/OpenCL-ICD-Loader-icd_linux_envvars.o $(OBJ_DIR)/OpenCL-ICD-Loader-icd_linux.o $(OBJ_DIR)/OpenCL-ICD-Loader-icd_dispatch_generated.o $(OBJ_DIR)/OpenCL-ICD-Loader-icd_dispatch.o $(OBJ_DIR)/OpenCL-ICD-Loader-icd.o
	$(HIDE) mkdir -p $(BIN_DIR)
	$(HIDE) clang++ -shared $(LD_FLAGS) -Wl,--version-script=$(THIRD_PARTY_DIR)/OpenCL-ICD-Loader/src/linux/icd_exports.map $(OBJ_DIR)/OpenCL-ICD-Loader-icd_linux_envvars.o $(OBJ_DIR)/OpenCL-ICD-Loader-icd_linux.o $(OBJ_DIR)/OpenCL-ICD-Loader-icd_dispatch_generated.o $(OBJ_DIR)/OpenCL-ICD-Loader-icd_dispatch.o $(OBJ_DIR)/OpenCL-ICD-Loader-icd.o -o $(BIN_DIR)/libOpenCL.so

# Compile
$(OBJ_DIR)/Deep-Learning-Logistic-Regression-inference-main.o: $(CODE_DIR)/Deep-Learning/Logistic-Regression/inference-main.cpp
	$(HIDE) mkdir -p $(OBJ_DIR)
	$(HIDE) clang++ -c $(C_FLAGS) $(CODE_DIR)/Deep-Learning/Logistic-Regression/inference-main.cpp -MD -MF $(OBJ_DIR)/Deep-Learning-Logistic-Regression-inference-main.d -o $(OBJ_DIR)/Deep-Learning-Logistic-Regression-inference-main.o

$(OBJ_DIR)/Deep-Learning-Multinomial-Logistic-Regression-inference-main.o: $(CODE_DIR)/Deep-Learning/Multinomial-Logistic-Regression/inference-main.cpp
	$(HIDE) mkdir -p $(OBJ_DIR)
	$(HIDE) clang++ -c $(C_FLAGS) $(CODE_DIR)/Deep-Learning/Multinomial-Logistic-Regression/inference-main.cpp -MD -MF $(OBJ_DIR)/Deep-Learning-Multinomial-Logistic-Regression-inference-main.d -o $(OBJ_DIR)/Deep-Learning-Multinomial-Logistic-Regression-inference-main.o
...
-include \
	$(OBJ_DIR)/Deep-Learning-Logistic-Regression-inference-main.d \
	$(OBJ_DIR)/Deep-Learning-Multinomial-Logistic-Regression-inference-main.d \
...
clean:
	$(HIDE) rm -f $(BIN_DIR)/Deep-Learning-Logistic-Regression
	$(HIDE) rm -f $(BIN_DIR)/Deep-Learning-Multinomial-Logistic-Regression
	$(HIDE) rm -f $(BIN_DIR)/libOpenCL.so
	$(HIDE) rm -f $(OBJ_DIR)/Deep-Learning-Logistic-Regression-inference-main.o
	$(HIDE) rm -f $(OBJ_DIR)/Deep-Learning-Multinomial-Logistic-Regression-inference-main.o
	...
	$(HIDE) rm -f $(OBJ_DIR)/Deep-Learning-Logistic-Regression-inference-main.d
	$(HIDE) rm -f $(OBJ_DIR)/Deep-Learning-Multinomial-Logistic-Regression-inference-main.d
