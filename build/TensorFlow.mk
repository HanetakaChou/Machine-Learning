...
# TENSORFLOW_LITE_DIR := $(shell pip show tflite-runtime | grep Location | cut -d ' ' -f 2)/tflite_runtime
...
$(BIN_DIR)/TensorFlow-Neural-Network: $(OBJ_DIR)/TensorFlow-Neural-Network-inference-main.o $(BIN_DIR)/libOpenCL.so $(BIN_DIR)/libtensorflowlite_c.so
	...
	$(HIDE) clang++ -pie $(LD_FLAGS) $(OBJ_DIR)/TensorFlow-Neural-Network-inference-main.o $(BIN_DIR)/libOpenCL.so $(BIN_DIR)/libtensorflowlite_c.so -o $(BIN_DIR)/TensorFlow-Neural-Network
...
$(BIN_DIR)/TensorFlow-Multinomial-Logistic-Regression: $(OBJ_DIR)/TensorFlow-Multinomial-Logistic-Regression-inference-main.o $(BIN_DIR)/libOpenCL.so $(BIN_DIR)/libtensorflowlite_c.so $(BIN_DIR)/libopenblasp.so $(BIN_DIR)/libgfortran.so $(BIN_DIR)/libquadmath.so
	$(HIDE) mkdir -p $(BIN_DIR)
	$(HIDE) clang++ -pie $(LD_FLAGS) $(OBJ_DIR)/TensorFlow-Multinomial-Logistic-Regression-inference-main.o $(BIN_DIR)/libOpenCL.so $(BIN_DIR)/libtensorflowlite_c.so $(BIN_DIR)/libopenblasp.so $(BIN_DIR)/libgfortran.so $(BIN_DIR)/libquadmath.so -o $(BIN_DIR)/TensorFlow-Multinomial-Logistic-Regression
...
$(BIN_DIR)/TensorFlow-Regression-Based-Collaborative-Filtering: $(OBJ_DIR)/TensorFlow-Collaborative-Filtering-regression-inference-main.o $(BIN_DIR)/libOpenCL.so $(BIN_DIR)/libtensorflowlite_c.so $(BIN_DIR)/libopenblasp.so $(BIN_DIR)/libgfortran.so $(BIN_DIR)/libquadmath.so
	$(HIDE) mkdir -p $(BIN_DIR)
	$(HIDE) clang++ -pie $(LD_FLAGS) $(OBJ_DIR)/TensorFlow-Collaborative-Filtering-regression-inference-main.o $(BIN_DIR)/libOpenCL.so $(BIN_DIR)/libtensorflowlite_c.so $(BIN_DIR)/libopenblasp.so $(BIN_DIR)/libgfortran.so $(BIN_DIR)/libquadmath.so -o $(BIN_DIR)/TensorFlow-Regression-Based-Collaborative-Filtering
...
$(BIN_DIR)/TensorFlow-Classification-Based-Collaborative-Filtering: $(OBJ_DIR)/TensorFlow-Collaborative-Filtering-classification-inference-main.o $(BIN_DIR)/libOpenCL.so $(BIN_DIR)/libtensorflowlite_c.so $(BIN_DIR)/libopenblasp.so $(BIN_DIR)/libgfortran.so $(BIN_DIR)/libquadmath.so
	$(HIDE) mkdir -p $(BIN_DIR)
	$(HIDE) clang++ -pie $(LD_FLAGS) $(OBJ_DIR)/TensorFlow-Collaborative-Filtering-classification-inference-main.o $(BIN_DIR)/libOpenCL.so $(BIN_DIR)/libtensorflowlite_c.so $(BIN_DIR)/libopenblasp.so $(BIN_DIR)/libgfortran.so $(BIN_DIR)/libquadmath.so -o $(BIN_DIR)/TensorFlow-Classification-Based-Collaborative-Filtering
...
$(BIN_DIR)/TensorFlow-Reinforcement-Learning : $(OBJ_DIR)/TensorFlow-Reinforcement-Learning-inference-main.o $(BIN_DIR)/libOpenCL.so $(BIN_DIR)/libtensorflowlite_c.so $(BIN_DIR)/libopenblasp.so $(BIN_DIR)/libgfortran.so $(BIN_DIR)/libquadmath.so $(BIN_DIR)/libpython39.so
	$(HIDE) mkdir -p $(BIN_DIR)
	$(HIDE) clang++ -pie $(LD_FLAGS) $(OBJ_DIR)/TensorFlow-Reinforcement-Learning-inference-main.o $(BIN_DIR)/libOpenCL.so $(BIN_DIR)/libtensorflowlite_c.so $(BIN_DIR)/libopenblasp.so $(BIN_DIR)/libgfortran.so $(BIN_DIR)/libquadmath.so $(BIN_DIR)/libpython39.so -o $(BIN_DIR)/TensorFlow-Reinforcement-Learning
...
# Compile
$(OBJ_DIR)/TensorFlow-Neural-Network-inference-main.o: $(CODE_DIR)/TensorFlow/Neural-Network/inference-main.cpp
	$(HIDE) mkdir -p $(OBJ_DIR)
	$(HIDE) clang++ -c $(C_FLAGS) $(CODE_DIR)/TensorFlow/Neural-Network/inference-main.cpp -MD -MF $(OBJ_DIR)/TensorFlow-Neural-Network-inference-main.d -o $(OBJ_DIR)/TensorFlow-Neural-Network-inference-main.o

$(OBJ_DIR)/TensorFlow-Multinomial-Logistic-Regression-inference-main.o: $(CODE_DIR)/TensorFlow/Multinomial-Logistic-Regression/inference-main.cpp
	$(HIDE) mkdir -p $(OBJ_DIR)
	$(HIDE) clang++ -c $(C_FLAGS) $(CODE_DIR)/TensorFlow/Multinomial-Logistic-Regression/inference-main.cpp -MD -MF $(OBJ_DIR)/TensorFlow-Multinomial-Logistic-Regression-inference-main.d -o $(OBJ_DIR)/TensorFlow-Multinomial-Logistic-Regression-inference-main.o

$(OBJ_DIR)/TensorFlow-Collaborative-Filtering-regression-inference-main.o: $(CODE_DIR)/TensorFlow/Collaborative-Filtering/regression-inference-main.cpp
	$(HIDE) mkdir -p $(OBJ_DIR)
	$(HIDE) clang++ -c $(C_FLAGS) $(CODE_DIR)/TensorFlow/Collaborative-Filtering/regression-inference-main.cpp -MD -MF $(OBJ_DIR)/TensorFlow-Collaborative-Filtering-regression-inference-main.d -o $(OBJ_DIR)/TensorFlow-Collaborative-Filtering-regression-inference-main.o

$(OBJ_DIR)/TensorFlow-Collaborative-Filtering-classification-inference-main.o: $(CODE_DIR)/TensorFlow/Collaborative-Filtering/classification-inference-main.cpp
	$(HIDE) mkdir -p $(OBJ_DIR)
	$(HIDE) clang++ -c $(C_FLAGS) $(CODE_DIR)/TensorFlow/Collaborative-Filtering/classification-inference-main.cpp -MD -MF $(OBJ_DIR)/TensorFlow-Collaborative-Filtering-classification-inference-main.d -o $(OBJ_DIR)/TensorFlow-Collaborative-Filtering-classification-inference-main.o

$(OBJ_DIR)/TensorFlow-Reinforcement-Learning-inference-main.o: $(CODE_DIR)/TensorFlow/Reinforcement-Learning/inference-main.cpp
	$(HIDE) mkdir -p $(OBJ_DIR)
	$(HIDE) clang++ -c $(C_FLAGS) $(CODE_DIR)/TensorFlow/Reinforcement-Learning/inference-main.cpp -MD -MF $(OBJ_DIR)/TensorFlow-Reinforcement-Learning-inference-main.d -o $(OBJ_DIR)/TensorFlow-Reinforcement-Learning-inference-main.o
